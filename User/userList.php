        ...
        <form method="post" id="addform" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <select name="EmployeeId" id="EmployeeId" class="form-control" required='true'>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="createBy" id="createBy" value="<?php echo $_SESSION["EmployeeId"]; ?>" />
                    <input type="submit" onclick="addRecord();" class="btn btn-success" value="Add" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <form method="post" id="editform" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label>Employee Name</label>
                    <select name="up_employeeId" id="up_employeeId" class="form-control" required='true'>
                    ...
                    <br />
                    <label>User Name</label>
                    <input type="text" name="up_userName" id="up_userName" class="form-control" required="true" />
                    <br />
                    <label>User Password</label>
                    <input type="text" name="up_userPassword" id="up_userPassword" class="form-control" required="true" />
                    <br />
                    <label>User Type</label>
                    <input type="text" name="up_userType" id="up_userType" class="form-control" required="true" />
                    <br />


                </div>
                <div class="modal-footer">
                    <input type="hidden" name="up_crateBy_id" id="up_crateBy_id" value="<?php echo $_SESSION["EmployeeId"]; ?>" />
