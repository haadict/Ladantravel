					...
					<?php 
					 ...
					 while($row=$result->fetch()){
						 ...
						 echo '
						  <tr>
						    <td>'.$i.'</td>
							<td>'.$row["Prefix"].$row["invoiceNo"].'</td>
							<td>'.$row["ServiceType"].'</td>
							<td>'.$row["CustomerName"].'</td>
							<td>'.$row["Quantity"].'</td>
							<td>'.$row["Total"].'</td>
							<td>
							<button class="btn btn-info btn-circle" type="button" onclick="GetCustomerDetails('.$row["invoiceId"].')"><i class="fa fa-check"></i>
                            </button>
 ...
 <div class="modal-dialog">
  <form method="post" id="user_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-footer">
     <input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION["CustId"];?>"/>
     <input type="hidden" name="hidden_custId" id="hidden_custId" />
