   ...
   <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Expense Type Tables</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        <th>No</th>
                        <th>Expense Type</th>
                        <th>Expense Type Registered Date</th>
					 ...
					 while($row=$result->fetch()){
						 ...
						 echo '
						  <tr>
							...
							<td>'.$row["ExpenseTypeCreateDate"].'</td>
							<td>
							<button class="btn btn-info btn-circle" type="button" onclick="GetUpdateDetails('.$row["ExpenseTypeId"].')"><i class="fa fa-check"></i>
                            </button>
							<button class="btn btn-warning btn-circle delete" type="button" onclick="GetDelete('.$row["ExpenseTypeId"].')"><i class="fa fa-times"></i>
                            </button>
							</td>
						  </tr>
						 ';
  ...
  <form method="post" id="addform" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-body">
     ...
     <input type="text" name="exp_type" id="exp_type" class="form-control" />
     <br />
 ...
 <div class="modal-dialog">
  <form method="post" id="editform" enctype="multipart/form-data">
   <div class="modal-content">
    <div class="modal-header">
     <button type="button" class="close" data-dismiss="modal">&times;</button>
     <h4 class="modal-title">Update Expense Type</h4>
    </div>
    <div class="modal-body">
     <label>Expense Type</label>
     <input type="text" id="up_exp_type" class="form-control" />
     <br />
